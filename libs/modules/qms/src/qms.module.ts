...
import { CAPA_REPOSITORY, NONCONFORMANCE_REPOSITORY } from './domain/ports/qms.repository';
...
@Module({
  ...
  controllers: [NonconformanceController, CapaController],
  providers: [
  ...
  exports: [NonconformanceService, CapaService],
})
